...
export function Bookshelf({
    ...
    center,
    columns = 4,
}: PropsWithChildren<{ center?: boolean, columns?: number }>) {
    return (
        <div className="bookshelf not-prose breakout" style={{ "--columns": columns } as React.CSSProperties}>
            <div
                className={cn(

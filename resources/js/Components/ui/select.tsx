...
>(({ className, children, ...props }, ref) => (
    ...
    >
        ...
        <SelectPrimitive.Icon>
            <ChevronsUpDown data-select-icon className="size-3" />
        </SelectPrimitive.Icon>
    </SelectPrimitive.Trigger>
));
    ...
    <SelectPrimitive.Portal container={container}>
        ...
        >
            <SelectPrimitive.Popup className={cn(
                ...
                "group origin-[var(--transform-origin)] rounded-md bg-popover py-1 shadow-sm shadow-black/5 outline-1 outline-border transition-[transform,scale,opacity] data-[ending-style]:scale-100 data-[ending-style]:opacity-100 data-[ending-style]:transition-none data-[starting-style]:scale-90 data-[starting-style]:opacity-0 data-[side=none]:data-[starting-style]:scale-100 data-[side=none]:data-[starting-style]:opacity-100 data-[side=none]:data-[starting-style]:transition-none -outline-offset-1",
                className
            )}>

    ...
    <SelectPrimitive.Portal container={container}>
        ...
        >
            <SelectPrimitive.Popup className={cn(
                ...
                "group origin-[var(--transform-origin)] rounded-md bg-popover py-1 shadow-lg shadow-black/10 outline-1 outline-accent transition-[transform,scale,opacity] data-[ending-style]:scale-100 data-[ending-style]:opacity-100 data-[ending-style]:transition-none data-[starting-style]:scale-90 data-[starting-style]:opacity-0 data-[side=none]:data-[starting-style]:scale-100 data-[side=none]:data-[starting-style]:opacity-100 data-[side=none]:data-[starting-style]:transition-none -outline-offset-1",
                className
            )}>
